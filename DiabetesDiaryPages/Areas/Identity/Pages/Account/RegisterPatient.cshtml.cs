...
namespace DiabetesDiaryPages.Areas.Identity.Pages.Account
{
    public class RegisterPatientModel : PageModel
    {
        ...
        public RegisterPatientModel(
            ...
            DiabetesDiaryDbContext diabetesDiaryDbContext)
        {
        ...
        public IList<SelectListItem> DiabetesTypeSelectionList { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            DiabetesTypeSelectionList = _diabetesDiaryDbContext.TipDijabetes.
                ToList()
                .Select(td => new SelectListItem(td.Ime, td.Id.ToString()))
                .ToList();
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var person = new Covek()
                {
                    Ime = Input.Name,
                    Prezime = Input.Surname,
                    Email = Input.Email,
                    Embg = Input.Ssn,
                    DatumNaRagjanje = DateOnly.FromDateTime(Input.DateOfBirth),
                ...
                try
                { 
                    await _diabetesDiaryDbContext.AddAsync(person, CancellationToken.None);
                    await _diabetesDiaryDbContext.SaveChangesAsync(CancellationToken.None);
                }
                catch (Exception ex)
                {
                ...
                {
                    _diabetesDiaryDbContext.Remove(person);
                    _diabetesDiaryDbContext.SaveChanges();
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(IdentityUser)}'. " +
                    ...
                    $"override the register page in /Areas/Identity/Pages/Account/RegisterPatient.cshtml");
            }
        }
